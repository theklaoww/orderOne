<%-- 
    Document   : home
    Created on : Nov 1, 2020, 8:49:29 PM
    Author     : User
--%>
...
<body>
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-white portfolio-navbar gradient">
        <div class="container"><a class="navbar-brand logo" href="#">orderOne</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navbarNav"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        ...
        <section class="portfolio-block call-to-action border-bottom">
            <div class="container">
                <div class="d-flex justify-content-center align-items-center content">
                    <h3>มี บัญชี orderOne</h3><button class="btn btn-outline-primary btn-lg" type="button">คลิก</button></div>
            </div>
        </section>
        <section class="portfolio-block call-to-action border-bottom">
            <div class="container">
                <div class="d-flex justify-content-center align-items-center content">
                    <h3>ไม่มี บัญชี orderOne ใช่มั้ย</h3><button class="btn btn-outline-primary btn-lg" type="button">ลงทะเบียน</button></div>
            </div>
        </section>
